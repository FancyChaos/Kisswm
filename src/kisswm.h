...
void            client_focus(Client*, bool);
void            focus(Window, Client*, bool);
void            arrange(void);
void            arrangemon(Monitor*);
void            window_set_size(Window, int, int, int, int);
void            window_set_dimension(Window, int, int);
void            window_set_position(Window, int, int);
void            client_set_size(Client*, int, int, int, int);
void            client_set_dimension(Client*, int, int);
void            client_set_position(Client*, int, int);
void            client_default_position(Client*, bool);
void            client_center(Client*);
...
int mouse_last_x = 0;
int mouse_last_y = 0;
unsigned int mouse_last_button = 0;
